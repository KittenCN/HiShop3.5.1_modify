namespace Hidistro.UI.Common.Controls
{
    ...
    public class UpImg : WebControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            control5.Attributes.Add("href", "javascript:DeleteImage('" + this.ID + "','" + this.UploadType.ToString().ToLower() + "'," + (this.isNeedThumbnail ? "1" : "0") + ");");
        ...
        public override void RenderControl(HtmlTextWriter writer)
        {
            ...
            {
                string str2 = "$(document).ready(function() { InitUploader(\"" + this.ID + "\", \"" + this.UploadType.ToString().ToLower() + "\"," + (this.isNeedThumbnail ? "1" : "0") + ",'" + this.UploadSize + "');";
                if (this.IsUploaded)
                {
                    string str3 = str2;
                    str2 = str3 + "UpdatePreview('" + this.ID + "', '" + this.uploadedImageUrl + "');";
                }
