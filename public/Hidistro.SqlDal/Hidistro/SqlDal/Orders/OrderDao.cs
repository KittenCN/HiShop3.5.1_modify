namespace Hidistro.SqlDal.Orders
{
    ...
    public class OrderDao
    {
		...
		public bool Add(OrderTmpInfo model)
        {
            ...
            database.AddInParameter(dbCommand, "ServiceMoney", DbType.Decimal, model.ServiceMoney);
            //int result;
        ...
        public bool UpdateSM(string orderId, decimal newServiceMoney)
        {
            DbCommand sqlStringCommand = this.database.GetSqlStringCommand("UPDATE Hishop_Orders SET ServiceMoney=@newServiceMoney WHERE OrderId =@OrderId");
            this.database.AddInParameter(sqlStringCommand, "newServiceMoney", DbType.Decimal, newServiceMoney);
            this.database.AddInParameter(sqlStringCommand, "OrderId", DbType.String, orderId);
            return (this.database.ExecuteNonQuery(sqlStringCommand) > 0);
        }
