<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="RecycleStationDetail.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Trade.RecycleStationDetail" %>
                ...
                <div class="modal-content form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnAgreeConfirm" runat="server" CssClass="btn btn-success" Text="确定" OnClientClick="return HiConform('<strong>您正在执行确认退款操作！</strong><p>同意退款以后不可恢复，是否继续？</p>',this);" />
