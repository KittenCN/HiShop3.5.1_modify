<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="OneyuanList.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Oneyuan.OneyuanList" %>
    ...
    <script>
        ...
        function BatchDel()
        {
            ...
            $("input[name=CheckBoxGroup]:checked").each(function () {
                ...
                if (candel == "1") {
                    ...
                    $(this).prop("checked", "disabled");//将控件修改为不可选
                }
            });
        ...
        $(function () {
            ...
            $("#sells1").click(function () {
                //新增的代码,控制开奖状态为退款完成,未开奖,成功开奖的不可选
                $("input[name=CheckBoxGroup]:checked").each(function () {
                    var candel = $(this).attr("candel");
