<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddOneyuanInfo.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Oneyuan.AddOneyuanInfo" %>
...
di{color:red}
    ...
    <script type="text/javascript">
        ...
        if (EditJsonData != null && EditJsonData.ActivityId != null) {
            ...
            postData = {
                action: "save", ActivityId: "", IsOn: true, Title: "活动标题未设置", StartTime: "", EndTime: "", HeadImgage: "http://fpoimg.com/640x200", ReachType: 3,
        ...
        function saveinfo(obj) {
            ...
            if (parseInt(postData.ReachNum) < parseInt(postData.PrizeNumber)) {
                HiTipsShow("满足份数不能小于奖品数量！", "error");
                return;
            }
       ...
       // $(document).ready(function ()
        {
            ...
            $("#ReachNum").keyup(function () {
                if ($(this).val()!=""&&!/^[1-9]\d{0,7}$/.test($(this).val())) {
                ...
                <div class="form-horizontal clearfix">
                    ...
                    <div class="form-group setmargin">
                        ...
                        <div class="form-inline journal-query col-xs-9">
                            ...
                            <small>点击上传，建议尺寸：640 x 200 像素，小于300KB</small>
                        </div>
                    </div>
                ...
                <div class="form-horizontal clearfix">
                    ...
                    <div class="form-group setmargin">
                        ...
                        <div class="form-inline col-xs-9">
                            <div class="resetradio mb5 pt3">
                                <label class="mr20">
                                    <input type="radio" name="ReachType" value="3" checked>到结束时间并达到满足份数开奖(<span class="red">推荐</span>)</label>
                                <small>在结束时间前，可以一直购买，达到结束时间且达到满足份数后自动开奖。
                                </small>
                               <%-- <small class="red">以上三种方式，都会有0至30分钟的延迟开奖</small>--%>
                            </div>
                            <div class="resetradio mb5 pt3">
                                <label class="mr20">
