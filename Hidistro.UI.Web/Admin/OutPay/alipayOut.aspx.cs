...
{
    public partial class alipayOut : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string str5 = "utf-8";
            Hidistro.ControlPanel.OutPay.App.Core.setConfig(partner, "MD5", str2, str5);
            string str6 = Globals.HostPath(HttpContext.Current.Request.Url) + "/admin/OutPay/AliPaynotify_url.aspx";
            ...
            string str12 = Hidistro.ControlPanel.OutPay.App.Core.BuildRequest(sParaTemp, "get", "确认");
