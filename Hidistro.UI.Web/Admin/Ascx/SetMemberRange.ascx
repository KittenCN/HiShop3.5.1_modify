<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetMemberRange.ascx.cs" Inherits="Hidistro.UI.Web.Admin.Ascx.SetMemberRange" %>
...
<script type="text/javascript">
    ...
    function readMemberCustomGroupsAndGrade() {
        ...
        <% if (Hidistro.Core.Globals.RequestQueryStr("action") == "deital" || Hidistro.Core.Globals.RequestQueryNum("View") == 1)
           {%>
                    $("input,textarea,select").attr("disabled", "false");
                    $("#mySwitch").attr("class", "switch1 fl has-switch deactivate");
        <% }%>
