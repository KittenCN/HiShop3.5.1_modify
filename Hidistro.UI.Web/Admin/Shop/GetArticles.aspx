<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetArticles.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Shop.GetArticles" %>
                ...
                <div class="mate-tabl" id="articleContainer">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home">
                            <p class="mateleng">图文素材列表：(共<span><%=recordcount %></span>条)<span style="color:#999; padding-left: 30px;">如果您近期更换过域名，请<input value="点击这里" class="btnLink" type="button" onclick="ClearWeiXinSucai()">重新同步获取微信素材信息</span></p>
