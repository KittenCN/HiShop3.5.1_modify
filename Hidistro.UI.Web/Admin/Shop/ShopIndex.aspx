<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ShopIndex.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Shop.ShopIndex" %>
                        ...
                        <li class="<%# Eval("ThemeName").ToString ()==tempLatePath ?  "active" :""  %>">
                           <div class="img">
                                ...
                                <div class="lightBtn">
                                    ...
                                    <input type ="button" class="btn btn-sm btn-success"  value ="使用模板" dataID="<%# Eval("ThemeName") %>" >
                               </div>
