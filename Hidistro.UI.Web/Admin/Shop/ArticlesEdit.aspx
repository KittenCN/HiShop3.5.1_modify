...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/Admin/js/HiShopComPlugin.js?20160818"></script>
    <script src="/Admin/shop/Public/js/dist/componentadmin-min.js?20160712"></script>
    <style type="text/css">
        .jbox-container {
            overflow-x: hidden;
        }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#dropdow-menu-link  li[data-val='13'],#dropdow-menu-link  li[data-val='23']").remove();
            ...
            $("#btn-save").click(function () {
                ...
                var memo =$("#digest").val();
                if($.trim(memo)==""){
                    memo=getStrbylen(UE.getEditor('ctl00_ContentPlaceHolder1_fkContent_txtMemo').getContentTxt(),240);
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    </form><script type="text/j-template" id="tpl_hint">
