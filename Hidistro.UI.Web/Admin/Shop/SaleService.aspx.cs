...
{
    public partial class SaleService : AdminPage
    {
        ...
        protected void btnBindUser_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(tokenValue))
            {
                ...
                {
                    string jsonValue = Hishop.MeiQia.Api.Util.Common.GetJsonValue(str6, "errcode");
                    Hishop.MeiQia.Api.Util. Common.GetJsonValue(str6, "errmsg");
                    if (jsonValue == "10020")
                    {
        ...
        protected void ChangePwd_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(tokenValue))
            {
                ...
                {
                    string jsonValue = Hishop.MeiQia.Api.Util.Common.GetJsonValue(str4, "errcode");
                    string str6 = Hishop.MeiQia.Api.Util.Common.GetJsonValue(str4, "errmsg");
                    if (jsonValue == "0")
                    {
