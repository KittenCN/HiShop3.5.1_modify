<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="OrderStatistics.aspx.cs" Inherits="Hidistro.UI.Web.Admin.TongJi.OrderStatistics" %>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th width="10%">用户名</th>
                                <th width="12%" style="text-align:left">店名/联系人</th>
                                <th width="10%">销售额</th>
                                <th width="6%">订单数</th>
                                <th width="10%">成交用户</th>
                                <th width="10%">客户单价</th>
