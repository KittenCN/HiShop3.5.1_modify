...
{
    public partial class OrderStatisticsDetail_L2 : AdminPage
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                this.BeginDate = new DateTime?(this.txtBeginDate.SelectedDate.Value);
            }
            if (this.txtEndDate.SelectedDate.HasValue)
            {
                this.EndDate = new DateTime?(this.txtEndDate.SelectedDate.Value);
            }
            this.lastDay = 0;
            this.ReBind_Url(true);
        }
