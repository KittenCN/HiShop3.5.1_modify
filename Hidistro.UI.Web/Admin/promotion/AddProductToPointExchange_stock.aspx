<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddProductToPointExchange_stock.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddProductToPointExchange_stock" %>
            ...
            if (id == null) {
                ...
                $('input[name="CheckBoxGroup"]').each(function () {
                    ...
                    if ($(this).prop('checked')) {
                        ...
                        if (!flag) return;
                        $(this).parent().next().next().next().next().next().prev().find('input.inputCss').each(function () {
                            if (!checkInt($(this).val())) {
