<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="PointExchange.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.PointExchange" %>
            ...
            <div class="col-xs-5">
                <div class="shop-logo" style="position: relative">
                    ...
                    <div style="clear: both; color: #808080; font-size: 12px; padding-top: 10px">
                        建议尺寸：618 x 200 像素，小于300KB，支持jpg、gif、png格式
                    </div>
                </div>
            </div>
        </div>
