<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="LimitedTimeDiscountList.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.LimitedTimeDiscountList" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="border_top border_bottom" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                           ...
                           <span <%#(Convert.ToDateTime(Eval("EndTime"))<DateTime.Now?"style=\"display:none;\"":"") %>>   
                            <span>          
