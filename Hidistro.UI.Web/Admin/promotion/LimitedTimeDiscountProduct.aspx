<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="LimitedTimeDiscountProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.LimitedTimeDiscountProduct" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.msg == "success") {
                        HiTipsShow("修改成功", "success", function () {
                            //document.location.href = document.location.href;
                            document.location.href = "/Admin/Promotion/LimitedTimeDiscountList.aspx";  //将页面跳转至限时折扣列表页面
                        });
                    }
                    else {
                        HiTipsShow(data.msg, "error");
    ...
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div class="set-switch" style="margin-top: 10px;">
            <div class="form-inline" style="margin-top: 5px; margin-bottom: 5px; vertical-align: central;">
                ...
                商品分类:<Hi:ProductCategoriesDropDownListNew  ID="dropCategories" CssClass="form-control resetSize inputw150" runat="server" NullToDisplay="请选择商品分类" Width="200px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%">
                                            ...
                                            <div id="edit<%# Eval("ProductId") %>" style="display: none">
                                                ...
                                                <span class="divDiscountCss">最终价:<input style="margin:0 5px;width:40px;" id="FinalPrice<%# Eval("ProductId") %>" type="text" value="<%# Eval("FinalPrice","{0:f2}")%>" name="inputCss" class="inputCss" value="" disabled="disabled" />元</span>
