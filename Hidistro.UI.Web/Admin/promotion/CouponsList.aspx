<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="CouponsList.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.CouponsList" %>
                        ...
                        <UI:Grid ID="grdCoupondsList" runat="server" ShowHeader="true" OnRowDataBound="grdCoupondsList_RowDataBound" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="优惠券名称" SortExpression="CouponName">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <span title="[<%#FormatCouponTypes(Eval("CouponTypes").ToString()) %>]"><%# Eval("CouponName")%></span>
                                    </ItemTemplate>
                                </asp:TemplateField>
