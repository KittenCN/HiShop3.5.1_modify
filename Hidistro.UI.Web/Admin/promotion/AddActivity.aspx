<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddActivity.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.AddActivity" %>
   ...
   <%--     function setMember(){
        ...
        function saveData() {
            ...
            for (var i = 1; i < len+1; i++) {
                var cklen=$("input[name=select_"+i+"]:checked").length;
                if(parseInt(cklen) <1)
                {
                    ShowMsg("请选择优惠层级"+i+"的优惠方式！");
                    return false;
                }
            }
    ...
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div>
            ...
            <div class="form-group">
                ...
                <div class="form-inline col-xs-7 pt4">
            ...
            <div class="form-group">
                ...
                <div class="form-inline">
                    <input type="radio" name="attendsetting" id="rad1" style="margin-left: 15px;" checked="checked" />
                    普通优惠
                </div>
                <div class="form-inline">
                    <input type="radio" name="attendsetting" id="rad2" style="margin-left: 15px;" />
                    多级优惠<label
                            ...
                            <tr id="tr_1">
                                ...
                                <td style="width: 60%; text-align: left; vertical-align: central;">
                                    <div class="divClass">
                                        ...
                                        减
                                        <input type="text" name="redus" id="txt_redus_1" class="form-control" style="width: 100px;" />
                                        元
                                    </div>
                                    <div class="divClass">
                                        <input type="checkbox" name="select_1" id="chk2_1" />
                                        包邮
                                    </div>
                                    <div class="divClass">
                                        <input type="checkbox" name="select_1" id="chk3_1" />
                                        送
                                        <input type="text" name="point" id="txt_point_1" class="form-control" style="width: 100px;" />
                                        积分
                                    </div>
                                    <div class="divClass">
