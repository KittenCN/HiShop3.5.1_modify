<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="LimitedTimeDiscountAddProduct.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.LimitedTimeDiscountAddProduct" %>
        ...
        <div class="set-switch" style="margin-top: 10px;">
            <div style="margin-left: 15px">
                <input type="checkbox" id="selectAll" /><label for="selectAll">&nbsp;全选</label>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" id="hideOtherProduct" /><label for="hideOtherProduct">&nbsp;隐藏该页其他活动商品</label>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" id="hideThisProduct" /><label for="hideThisProduct">&nbsp;隐藏该页本活动商品</label>
            </div>
                                ...
                                <ItemTemplate>
                                    <tr id="<%# Eval("LimitedTimeDiscountId") %>">
                                        ...
                                        <td width="10%" style="text-align: right;">
                                            ...
                                            <span><%# Globals.ToNum(Eval("SkuNum"))>1?"<p style='text-align:right'><span style='background-color:rgb(153,153,153);padding:2px 5px;color:#fff;'>多规格</span></p>":""  %></span>
                                        </td>
                                        <td width="35%" style="text-align: center;">
                                            <div style="display: none" id="divDiscount<%# Eval("productws") %>">
                                               <span class="divDiscountCss">打<input type="text" name="discount" data="<%# Eval("productws") %>" id="discount<%# Eval("productws") %>" class="discount" style="width: 40px" value="<%# Eval("Discount", "{0:f2}")%>" />折</span>
                                                       ...
                                                       <span class="divDiscountCss">最终价<input type="text" name="finalprice" id="finalprice<%# Eval("productws") %>" style="width: 60px" class="inputCss" value="<%# Eval("FinalPrice", "{0:f2}")%>" disabled="disabled"/>元</span>
                                            </div>
