<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EmailSettings.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.EmailSettings" %>
        ...
        <div>
            <div class="formitem">
                <div class="emailhead">
                    ...
                    <p>
                        如果您需要经常面向大量用户邮箱进行邮件群发，建议你开通更高品质的<font style="color: Red">EDM邮件营销服务。</font><a href="http://zzfw.hishop.com.cn/edm/
"
