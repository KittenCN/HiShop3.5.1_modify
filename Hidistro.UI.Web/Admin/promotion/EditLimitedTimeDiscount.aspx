<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EditLimitedTimeDiscount.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.EditLimitedTimeDiscount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            var iscommission = $("#ctl00_ContentPlaceHolder1_IsCommision").is(':checked');
            if (iscommission) {
                $("#showDiscount").show();
            } else {
                $("#showDiscount").hide();
            ...
            $("#ctl00_ContentPlaceHolder1_IsCommision").click(function() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div class="set-switch resetBorder">
            ...
            <p><strong>佣金设置：</strong></p>
            <div class="form-horizontal clearfix">
                <div class="form-group setmargin">
                    <label class="col-xs-3 control-label pt4"><em>*</em>参与分佣：</label>
                    <div class="form-inline col-xs-9 pt4">
                        <asp:CheckBox runat="server" ID="IsCommision"  Text="分佣" Checked="true" />
                        <div id="showDiscount">
