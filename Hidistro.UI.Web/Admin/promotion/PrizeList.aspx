...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function printPosts() {
            ...
            if (orderIds == "" && pids=="") {
                ShowMsg("请选要打印的奖品", false);
            }
            else {
                var url = "BatchPrintData.aspx?OrderIds=" + orderIds + "&PIds=" + pids;
        ...
        function printGoods() {
            ...
            if (orderIds == "" && pids == "") {
                ...
                var url = "BatchPrintSendOrderGoods.aspx?OrderIds=" + orderIds + "&PIds=" + pids;
        ...
        function SetLogIdAndPid() {
            ...
            $("#ctl00_ContentPlaceHolder1_hidLogId").val(orderIds);
            $("#ctl00_ContentPlaceHolder1_hidPid").val(pids);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        ...
        <asp:HiddenField ID="hidLogId" Value="" runat="server" />
        <asp:HiddenField ID="hidPid" Value="" runat="server" />
                    ...
                    <div class="activediv" style="background-color: #fff">
                        ...
                        <div class="set-switch">
                            ...
                            <div class="reset-search" style="right: 110px; top: 50px">
                                ...
                                <asp:Button ID="btnExportButton" runat="server" Text="导出Excel" CssClass="btn btn-primary  resetSize " OnClick="btnExportButton_Click" OnClientClick="SetLogIdAndPid()" />
                            </div>
                        </div>

                        <div class="form-inline" style="margin-top: 10px; margin-bottom: 10px; margin-left: 5px; margin-left: 10px">
                             <% if (ShowTabNum == "2" || ShowTabNum == "3" || ShowTabNum == "4")
                               { %>
                                ...
                                <tbody>
                                    <asp:Repeater ID="reDistributor" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <input type="checkbox" name="CheckBoxGroup"   value="<%# Eval("LogId")%>" pid="<%#Eval("Pid") %>">&nbsp;&nbsp;&nbsp;
