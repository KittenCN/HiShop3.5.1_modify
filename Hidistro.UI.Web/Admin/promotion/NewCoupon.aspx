<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="NewCoupon.aspx.cs" Inherits="Hidistro.UI.Web.Admin.promotion.NewCoupon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveData()
        {
            ...
            if (maxNum >= Number(totalNum)) {
                ShowMsg("每人限领数量不能大于或者等于总发放量！", false);
                return false;
            }
