...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="form-horizontal clearfix">
                       <div class="form-inline mb10">
                            <div class="form-group">
                                <label for="ctl00_ContentPlaceHolder1_txtStoreName" style="margin-left:12px">店铺名称：</label>
                            ...
                            <div class="form-group" style="padding-left:1px">
                                <label for="ctl00_ContentPlaceHolder1_txtOrderId">　订单号：</label>
                                <asp:TextBox ID="txtOrderId"  CssClass="form-control  resetSize  inputw150" runat="server"  Width="150" />
                            </div>
                        </div>

                        <div class="form-inline mb10">
                            <label class="col-xs-1 pad control-label resetSize" style="font-weight:500" for="ctl00_ContentPlaceHolder1_calendarStartDate_txtDateTimePicker">时间范围：</label>
     ...
     <ItemTemplate>
      <tr  class="td_bg">
                                 <td>
                                  ...
                                  <td>
                                    &nbsp;<%# ((int)Eval("CommType")==4  || (int)Eval("CommType")==3)?"<span style='color:#ccc'>升级奖励</span>":(int)Eval("CommType")==5?"<span style='color:#ccc'>后台调整</span>":Eval("UserName")==DBNull.Value?"<span style='color:#ccc'>订单已删除</span>":Eval("UserName").ToString()%></td>
           <td width="200">
                                 &nbsp;<%# Eval("TradeTime", "{0:yyyy-MM-dd HH:mm:ss}")%></td>
          <td>&nbsp;<%# ((int)Eval("CommType")==4  || (int)Eval("CommType")==3)?"<span style='color:#FF6600'>升级奖励</span>":(int)Eval("CommType")==5?"<span style='color:#FF6600'>后台调整</span>":getNextName(Eval("UserId").ToString(),Eval("ReferralUserId").ToString(),Eval("ReferralPath").ToString())%></td>
        ...
        <tr  class="td_bg">
           ...
           <td width="200">
                                 &nbsp;<%# Eval("TradeTime", "{0:yyyy-MM-dd HH:mm:ss}")%></td>
          <td>&nbsp;<%# ((int)Eval("CommType")==4  || (int)Eval("CommType")==3)?"<span style='color:#FF6600'>升级奖励</span>":getNextName(Eval("UserId").ToString(),Eval("ReferralUserId").ToString(),Eval("ReferralPath").ToString())%></td>
          <td>&nbsp;<%# Eval("StoreName")%></td>
                                <td>
                                    &nbsp;￥<%# Eval("CommTotal","{0:F2}")%></td>
  ...
  <br />
        <div class="select-page clearfix">
                    <div class="form-horizontal fl" style="display:none">
