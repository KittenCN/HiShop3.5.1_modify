                ...
                <div class="tab-pane active">
                    ...
                    <div class="set-switch">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group mr20">
                                <label for="ctl00_ContentPlaceHolder1_txtMCellPhone">手机号码：</label>
                                 <asp:TextBox ID="txtMCellPhone" CssClass="form-control resetSize inputw150" runat="server" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mr20">  
                                <a class="bl mb5" href="DistributorFrozenList.aspx" style="cursor: pointer;">清除条件</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    DeleteMsg="取消分销商资质以后不可恢复也不能重新申请，是否继续？" />--%>
                                                        <asp:Button ID="ImageLinkButton1" Visible="false" CommandName="Forbidden" CommandArgument='<%# Eval("UserId")%>' class="btnLink pad"  runat="server" Text="取消分销商资质"   IsShow="true" OnClientClick="return HiConform('<strong>取消后不可恢复！</strong><p>确定要取消该分销商资质吗？</p>', this);" />
                                                   </p>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
