<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Default" %>
                    ...
                    <div class="data-list clearfix">
                        ...
                        <div class="shopnumber-list fl">
                            <ul>
                                ...
                                <li><span>会员总数：</span><a href="member/managemembers.aspx?MemberStatus=0"><%=MemberQty %></a></li>
