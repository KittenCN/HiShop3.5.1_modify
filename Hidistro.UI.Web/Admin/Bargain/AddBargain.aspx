<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="AddBargain.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Bargain.AddBargain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var iscommission = $("#ctl00_ContentPlaceHolder1_ckIsCommission").is(':checked');
            if (iscommission) {
                $("#showDiscount").show();
            } else {
                $("#showDiscount").hide();
            ...
            $("#ctl00_ContentPlaceHolder1_ckIsCommission").click(function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">
                ...
                <div class="fl frwidth">
                    ...
                    <div class="set-switch resetBorder">
                        ...
                        <div class="form-horizontal clearfix">
                            ...
                            <div class="form-group setmargin">
                                <label class="col-xs-3 resetSize control-label" for="pausername"><em>*</em>&nbsp;&nbsp;是否分佣：</label>
                                <div class="form-inline col-xs-9 pt2">
                                    <asp:CheckBox runat="server" ID="ckIsCommission" Text="分佣" Checked="true" />
                                    <div id="showDiscount">
                       <p style="padding-top:10px;">佣金折扣： <asp:TextBox runat="server" class="form-control resetSize" Width="70" ID="discount" Text="10" onkeyup="this.value = (this.value.match(/10|[0-9](\.\d{0,1})?/) || [''] )[0]"></asp:TextBox>折</p>
                        <p class="colorc">在商品销售佣金的基础上进行折扣计算(0&lt;折扣值&lt;=10)</p>
                            </div>
                                </div>
                            </div>
                            <div class="form-group setmargin">
        ...
        <div class="footer-btn navbar-fixed-bottom">
           ...
           <%--  <asp:Button runat="server" ID="Button1"  CssClass="btn btn-success" Text="保存" OnClientClick="return CheckData();"/>--%></div>
    </form>
</asp:Content>
