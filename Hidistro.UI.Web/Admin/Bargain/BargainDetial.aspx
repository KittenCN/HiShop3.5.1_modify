<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="BargainDetial.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Bargain.BargainDetial" %>
                            ...
                            <div class="form-group setmargin">
                              ...
                              <div class="form-group setmargin">
                                ...
                                <div class="form-inline col-xs-9">
                                    ...
                                    <div id="showDiscount">
                       <p style="padding-top:10px;">佣金折扣： <asp:TextBox runat="server" class="form-control resetSize" Width="70" ID="discount" Text="10" onkeyup="this.value = (this.value.match(/10|[0-9](\.\d{0,1})?/) || [''] )[0]" Enabled="false"></asp:TextBox>折</p>
