<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Weibo.menu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#dropdow-menu-link  li[data-val='20'],#dropdow-menu-link  li[data-val='23']").remove();
