<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="EditMember.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Member.EditMember" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        #ctl00_ContentPlaceHolder1_rsddlRegion select {
            width: 150px;
            float: left;
            margin-right: 5px;
        }
    ...
    <script type="text/javascript">
        ...
        function InitValidators(phoneReg) {
