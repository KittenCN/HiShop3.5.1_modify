<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="MembersIntegralQuery.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Member.MembersIntegralQuery" %>
                 ...
                 <div class="set-switch">
                    ...
                    <div class="form-group mr20">
                       ...
                       <label for="sellshop1">手机号码：</label>
                           ...
                           <div class="form-group mr20" style ="margin-left :-15px;">  <%--margin-left :30px;--%>
                  <a class="bl mb5" href="/Admin/member/MembersIntegralQuery.aspx" style="cursor: pointer">清除条件</a>  <%-- href="/admin/Member/ManageMembers.aspx"--%>
                      </div>  
                      </div>  
                      <div class="form-inline ">
                       ...
                       <div class="form-group mr20" style ="margin-left :65px;">
                        <label>会员等级：</label>                 
                            <Hi:MemberGradeDropDownList ID="rankList" Width="181" runat="server" CssClass="form-control resetSize"
                                AllowNull="true" NullToDisplay="全部" />
                            </div>   
                         <div class="form-group" style ="margin-left :-15px;">   <%--margin-left :30px;--%>
