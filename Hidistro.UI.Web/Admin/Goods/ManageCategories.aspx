<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ManageCategories.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ManageCategories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validatorForm() {
            ...
            var validreg = /^(0|(0+(\.[0-9]{1,2}))|[1-9]([0-9]?)(\.\d{1,2})?)$/;//   /^\d+(?=\.{0,1}\d+$|$)/;
            if (isNaN(categoryId)) {
            ...
            if ((!validreg.test(firstcommsion) && firstcommsion != "") || (!validreg.test(secondcommsion) && secondcommsion != "") || (!validreg.test(thirdcommsion) && thirdcommsion != "")) {
                ShowMsg('佣金比例只能输入0-100之间实数！', false);
                return false;
            }
            return true;
        }
