<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SimplePage.Master" AutoEventWireup="true" CodeBehind="EditBaseInfo.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.EditBaseInfo" %>
                ...
                <asp:TemplateField HeaderText="商品图片" ItemStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                        <a href='<%#"/ProductDetails.aspx?productId="+Eval("ProductId")%>' target="_blank">
                            <Hi:ListImage ID="ListImage1" runat="server" DataField="ThumbnailUrl40" Height="40" />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商品名称" ItemStyle-Width="15%" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                        <asp:TextBox ID="txtProductName" runat="server" Width="280px" Text='<%#Eval("ProductName") %>' MaxLength="200"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商品编码" ItemStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                        <asp:TextBox ID="txtProductCode" runat="server" Width="80px" Text='<%#Eval("ProductCode") %>' MaxLength="50"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="原价" HeaderStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                        <asp:TextBox ID="txtMarketPrice" runat="server" Width="80px" Text='<%#Eval("MarketPrice", "{0:F2}") %>' MaxLength="11"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </UI:Grid>
