<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ProductOnSales.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ProductOnSales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/Framenew.js?20160818"></script>
                ...
                <div class="tab-pane active">
                    ...
                    <div class="set-switch">
                        ...
                        <div class="form-inline">
                            <div class="form-group mr20">
                                <label for="sellshop4">商品编码：</label>
                        ...
                        <div class="reset-search">
                            <a class="bl mb5" onclick="Expansion.ClearQueryterm('productonsales.aspx');" style="cursor: pointer">清除条件</a>
