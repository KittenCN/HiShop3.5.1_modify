<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ProductOnDeleted.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ProductOnDeleted" %>
    ...
    <form runat="server">
        ...
        <div class="set-switch">
            ...
            <div class="reset-search">
                <a class="bl mb5" onclick="Expansion.ClearQueryterm('productondeleted.aspx');" style="cursor: pointer">清除条件</a>
