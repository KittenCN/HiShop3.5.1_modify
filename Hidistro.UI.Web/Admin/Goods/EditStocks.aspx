<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SimplePage.Master" AutoEventWireup="true" CodeBehind="EditStocks.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.EditStocks" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="set-switch">
      ...
      <UI:Grid ID="grdSelectedProducts"  CssClass="table table-bordered table-hover" DataKeyNames="SkuId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title"   GridLines="None" Width="100%">
                    <Columns> 
                    <asp:TemplateField HeaderText="商品编码" ItemStyle-Width="20%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            &nbsp;<%#Eval("SKU") %>                                             
                        </ItemTemplate>
                    </asp:TemplateField>
