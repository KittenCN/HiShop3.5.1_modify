<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ProductReviews.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ProductReviews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page" style="clear: both;">
                <!-- Nav tabs -->
