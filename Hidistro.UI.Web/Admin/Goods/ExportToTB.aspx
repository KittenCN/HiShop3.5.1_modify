<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="ExportToTB.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.ExportToTB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        #ctl00_ContentPlaceHolder1_grdProducts tr td img {
            height:40px;
        }
    </style>
                                    ...
                                    <asp:TemplateField HeaderText="商品">
                                        <ItemTemplate>
                                            ...
                                            <div  style="font-size: 12px;text-align: left;">
                                                ...
                                                <span class="colorC" style="display: block">商品编码：<%# Eval("ProductCode") %></span>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
