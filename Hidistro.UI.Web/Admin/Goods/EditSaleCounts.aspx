<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SimplePage.Master" AutoEventWireup="true" CodeBehind="EditSaleCounts.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Goods.EditSaleCounts" %>
    ...
    <form runat="server" style="width: 650px;">
        ...
        <UI:Grid ID="grdSelectedProducts" CssClass="table table-bordered table-hover" DataKeyNames="ProductId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
            <Columns>
                ...
                <asp:TemplateField HeaderText="商品编码" ItemStyle-Width="7%" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                        <%#Eval("ProductCode") %>
                    </ItemTemplate>
                </asp:TemplateField>
