...
<div style="text-align: right; ">
        <table style="display:none;">
            <tr>
                ...
                <td class="text-left">¥<span id='goodsmenoy<%# Eval("TemplateId") %>' class="Exemption ProductExemption"><%#Eval("Total", "{0:F2}") %> </span></td>
            </tr>
            <tr>
                <td class="text-right">优惠减免：</td>
                <td class="text-left">¥<span id='Exemption<%# Eval("TemplateId") %>' class="Exemption  Preferential"><asp:Literal runat="server" ID="litExemption"></asp:Literal></span><span style="display: none" id='oldExemption<%# Eval("TemplateId") %>'><asp:Literal runat="server" ID="litoldExemption"></asp:Literal></span>
            ...
            <tr>
                <td class="text-right">应付总额：</td>
                <td class="text-left"><strong class="text-danger">¥<label class="sumtotal"  id='total<%# Eval("TemplateId") %>' style="margin-bottom: 0;"><asp:Literal runat="server" ID="litTotal"></asp:Literal></label><label style="display: none" id='oldtotal<%# Eval("TemplateId") %>'><asp:Literal runat="server" ID="litoldTotal"></asp:Literal></label></strong></td>
            </tr></table>
    <div class="panel panel-default pad10 clearfix" <%# decimal.Parse(Eval("GetPointNumber").ToString())==0?"style=\"display:none\"":"" %>>
    	<table class="pull-right">
            ...
            <tr>
                ...
                <td class="text-left"><span class="text-danger"><%#Eval("GetPointNumber") %></span></td>
            </tr>
        </table>
    </div>
</div>
