...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
       ...
       #ctl00_ContentPlaceHolder1_grdExpressTemplates .td_left label input[type="checkbox"] {
        margin-top:-1px;
        }
    </style>
</asp:Content>
            ...
            <Columns>   
                <asp:TemplateField HeaderText="快递单模板名称" ItemStyle-CssClass="td_left"  >
                   <ItemTemplate><label>
                      ...
                      <asp:Literal ID="litXmlFile" runat="server" Text='<%#Eval("XmlFile") %>' Visible="false"></asp:Literal></label>
                   </ItemTemplate>
                </asp:TemplateField>                   
