...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    ...
                    <li id="liOper1">
                        <asp:HyperLink runat="server" NavigateUrl="SellerAlreadySent.aspx?stype=1"><span>货到付款订单</span></asp:HyperLink></li>
                </ul>
            </div>
                                            ...
                                            <td width="470">
                                                <div class="listInfoRight clearfix">
                                                    ...
                                                    <div class="operation fr">
                                                        ...
                                                        <a href="OrderDetails.aspx?OrderId=<%#Eval("OrderID") %>&type=showlogistic" target="_blank" class=" btn btn-primary resetSize inputw100 btnvieworders bl mb5">查看物流</a>
                                                        <input type="button" runat="server" class="btn btn-info resetSize inputw100 btnvieworders bl mb5 btnUpdateExpress" value="修改物流" ExpressCompanyAbb='<%# Eval("ExpressCompanyAbb") %>'  ShipOrderNumber='<%# Eval("ShipOrderNumber") %>'  ExpressCompanyName='<%# Eval("ExpressCompanyName") %>'  OrderId='<%# Eval("OrderId") %>' ShipName='<%# Eval("ShipTo") %>' OrderStatus='<%# GetOrderStatu(Eval("OrderStatus")) %>' />
                ...
                <div class="modal-content form-horizontal">
                    ...
                    <div class="modal-body">
                        <table class="table">
                            ...
                            <tr>
                                <td><label id="labName"></label></td>
                                <td><label id="labExOrderId"></label></td>
                                <td><span class="getcompanyname" title=""></span></td>
                                <td><input type="text" id="txtShipOrderNumber" class="inputw200" /></td>
                                <td><label id="labOrderStatus" ></label></td>
                            </tr>
                        </table>
                        <div class="modal-footer">
                            <input type="button" ID="btnSaveExpressInfo" value="保存"   class="btn btn-success" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".btnUpdateExpress").click(function () {
                var expressCompanyAbb = $(this).attr("ExpressCompanyAbb");
                var expressCompanyName = $(this).attr("ExpressCompanyName");
                var shipOrderNumber = $(this).attr("ShipOrderNumber");
                var orderId = $(this).attr("OrderId");
                var shipName = $(this).attr("ShipName");
                var orderStatus = $(this).attr("OrderStatus");
                

                $("#labName").text(shipName);
                $("#labExOrderId").text(orderId);
                $("#comp").val(expressCompanyAbb);
                $("#txtShipOrderNumber").val(shipOrderNumber);
                $("#labOrderStatus").text(orderStatus);
            ...
            $("#btnSaveExpressInfo").click(function () {
                var orderId = $("#labExOrderId").text();
