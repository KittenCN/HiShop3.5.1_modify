...
<%--            <small>管理员可管理售后服务QQ帐号和手机号码。</small>--%>
        ...
        <div class="tab-content">
            ...
            <div class="exitshopinfo maind" style="background-color:#fff;<%=enable ? "" : "display:none" %>">
                <h3>主账号<small style="display: inline; color: red; font-size: 14px; padding-left: 10px;">(美洽新系统升级，为了更好的服务体验，请 <a href="MeiQia.aspx" style="text-decoration:underline;">提供企业ID进行更新&gt;&gt;</a>)</small></h3>
                <div class="form-group">
