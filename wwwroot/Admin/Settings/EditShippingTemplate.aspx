...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveTemplates() {
            ...
            postData = { TemplateId: editTemplateId, task: "EditSave", Name: "", MUnit: 1, FreeShip: 0, HasFree: 0, shipperSelect: [], freeShippings: [],sName:"" }; //要POST的数据
        ...
        function initEdit(tempData) {
            ...
            $("input[value=" + tempData.FreeShip + "]").attr("checked", "checked")
