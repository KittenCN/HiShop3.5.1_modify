<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="MemberAmountApply.aspx.cs" Inherits="Hidistro.UI.Web.Admin.Member.MemberAmountApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function ShowRefuse() {
            ...
            $("#ctl00_ContentPlaceHolder1_RefuseMks").val("");
        }
        ...
        function ShowRefuseSignalShow(sid) {
            ...
            $("#ctl00_ContentPlaceHolder1_SignalrefuseMks").val("");
        ...
        function checkAlipay() {
            ...
            paydata += "^" + $("#ctl00_ContentPlaceHolder1_hdreferralblance").val() + "^余额提现";

            var jsondata = { Paydata: paydata };
            _postpgnow("/Admin/OutPay/alipayOutAmount.aspx", jsondata);
            return false;
        ...
        function checkBatchAlipay() {
            ...
            $('.content-table input[type="checkbox"]:checked').each(function () {
                ...
                PostData += "|" + SerialID + "^" + MerchantCode + "^" + AccountName + "^" + ReqSum + "^余额支付";
            });
            ...
            <div class="form-horizontal clearfix">
                ...
                <div class="form-inline  mr20">
                    ...
                    <div class="form-inline journal-query">
                        ...
                        <asp:Button ID="btnSearchButton" runat="server" class="btn resetSize btn-primary" Text="搜索" />&nbsp;&nbsp; <%--OnClick="btnQueryLogs_Click"--%>
                        <div class="form-group">
            ...
            <div class="title-table">
                <table class="table" style="margin-bottom: 0px">
                    <thead>
                        <tr>
                            <th width="42"></th>
                            <th width="140" style="text-align: left">用户名</th>
                ...
                <table class="table table-hover mar table-bordered" style="table-layout: fixed">
                    <tbody>
                        ...
                        <asp:Repeater ID="reCommissions" runat="server" OnItemDataBound="rptList_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr class="td_bg">
                                    <td width="30">&nbsp;<input name="CheckBoxGroup" type="checkbox" title="<%#Eval("State") %>" value='<%#Eval("Id") %>' /></td>
                                    <td width="100" style="text-align: left">&nbsp;&nbsp;<%# Eval("UserName")%>&nbsp;<br />
                                        &nbsp;&nbsp;<%# Eval("CellPhone")%></td>
                                    <td width="100"><%# Eval("RequestTime", "{0:yyyy-MM-dd HH:mm:ss}")%>&nbsp;</td>
                                    <td width="100" style="color:#F60">                                 
                                        ￥<%# Eval("Amount", "{0:F2}")%>                                            
                                    </td>
                                    <td width="100" ischeck='<%# Eval("State")%>' title="<%# Eval("RequestType")%>"><%# VShopHelper.GetCommissionPayType(Eval("RequestType").ToString()) %>&nbsp;
                                    </td>
                                    <td width="100" serialid="<%# Eval("Id")%>" merchantcode="<%# Eval("AccountCode") %>" userid="<%# Eval("UserId")%>">
                                        <%# Eval("AccountCode") %><br />
                                        <%# Eval("BankName") %>
                                    </td>
                                    ...
                                    <td width="100">
                                        <p style="margin-bottom: 4px">
                                            <Hi:ImageLinkButton ID="CheckOrGive" CssClass="btn btn-primary btn-xs" OnClientClick='return ShowPassSignal(this);return false' IsCheck='<%# Eval("State")%>' title='<%# Eval("Id")%>' CommandName="pass" CommandArgument='<%# Eval("Id")%>' runat="server" Text="审核" IsShow="true"
                                                DeleteMsg="审核通过？" />
                                        </p>

                                        <p>
                                            <a href="javascript:ShowRefuseSignalShow(<%# Eval("Id")%>)" class="btn btn-default btn-xs">驳回</a>
                                        </p>
                                    </td>
                                </tr>
                            </ItemTemplate>
